# workflows/ — mode d'emploi des workflows de référence

4 workflows n8n génériques, **sanitisés** (aucun credential, email, ID de compte ni URL d'instance). Ils sont importables tels quels dans n8n, mais **ne fonctionneront qu'après remplacement des placeholders et re-création des credentials dans le vault n8n**.
