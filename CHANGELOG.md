...
- **Qdrant repositioned** from "strongly recommended" to "scale-dependent." Below ~10 published pieces per month, the file-based fallback works fine. Each skill now has a documented `if qdrant_enabled / else` branch.
